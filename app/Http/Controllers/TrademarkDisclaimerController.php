...
class TrademarkDisclaimerController extends Controller
{
    public function index()
    {
        $disclaimer = [
            ...
            'date' => 'July 2026',
            'intro' => [
                'This Trademark Disclaimer explains the use of trademarks, service marks, trade names, logos, brand names, product names, and other intellectual property references that may appear on the XTech Mart website.',
                'By accessing and using this website, you acknowledge and agree to the terms outlined in this Trademark Disclaimer.',
                'XTech Mart operates as an independent technology, information, and product discovery platform. References to products, manufacturers, brands, trademarks, and related intellectual property are made solely for informational, identification, descriptive, and reference purposes.',
            ],
            'sections' => [
                [
                    ...
                    'body' => [
                        ...
                        'The inclusion of trademarks on this website does not transfer any intellectual property rights to XTech Mart or to website users.',
                    ],
                ],
                [
                ...
                [
                    ...
                    'body' => ['Unless expressly stated in writing, XTech Mart:'],
                ...
                [
                    ...
                    'notes' => [
                        ...
                        'XTech Mart does not claim ownership of any third-party product names or trademarks displayed on the website.',
                    ],
                ],
                [
                ...
                [
                    ...
                    'body' => [
                        ...
                        'XTech Mart makes reasonable efforts to use trademark references lawfully and appropriately.',
                    ],
                ],
                [
                ...
                [
                    ...
                    'body' => ['XTech Mart respects the intellectual property rights of trademark owners.', 'If a trademark owner believes that any content appearing on the website:'],
                ...
                [
                    ...
                    'body' => ['XTech Mart makes no representation or warranty regarding:'],
                ...
                [
                    ...
                    'body' => ['XTech Mart shall not be liable for any claims, losses, damages, or disputes arising from:'],
                ...
                [
                    ...
                    'body' => [
                        'XTech Mart reserves the right to modify, update, or replace this Trademark Disclaimer at any time without prior notice.',
