...
class WarrantyManufacturerInformationController extends Controller
{
    public function index()
    {
        $warrantyPolicy = [
            ...
            'date' => 'July 2026',
            'intro' => [
                'This Warranty and Manufacturer Responsibility Disclaimer explains the relationship between Zero Tech Mart, product manufacturers, and any warranties that may apply to products referenced on this website.',
                'Zero Tech Mart operates as a technology, information, and product discovery platform. The website provides information regarding technology products, including printers, scanners, desktops, thin clients, and related technology solutions.',
            ...
            'sections' => [
                [
                    ...
                    'items' => ['The role of Zero Tech Mart.', 'The responsibility of product manufacturers.', 'The scope of any manufacturer\'s warranties.', 'The limitations of the information presented on the website.', 'The absence of independent product warranties provided by Zero Tech Mart unless expressly stated.'],
                ...
                [
                    ...
                    'body' => ['Zero Tech Mart operates as an independent technology information platform.', 'Unless expressly stated in writing:'],
                    'items' => ['Zero Tech Mart is not a product manufacturer.', 'Zero Tech Mart is not a warranty provider.', 'Zero Tech Mart is not an authorized warranty service center.', 'Zero Tech Mart is not responsible for administering manufacturer warranties.', 'Zero Tech Mart does not make warranty decisions on behalf of manufacturers.'],
                    'note' => 'References to products on this website do not create any warranty obligations on the part of Zero Tech Mart.',
                    'highlight' => true,
                ],
                [
                ...
                [
                    ...
                    'body' => ['Unless expressly stated in writing, Zero Tech Mart does not provide:'],
                ...
                [
                    ...
                    'notes' => [
                        'Zero Tech Mart does not guarantee that warranty information displayed on the website is complete, current, or unchanged.',
                ...
                [
                    ...
                    'notes' => [
                        'Zero Tech Mart does not determine warranty eligibility and cannot guarantee that any particular product qualifies for warranty coverage.',
                        'Warranty determinations remain solely the responsibility of the manufacturer.',
                    ],
                ],
                [
                    'title' => 'Warranty Claims',
                    'body' => ['Any warranty claim should generally be directed to the applicable manufacturer or authorized warranty provider.', 'Zero Tech Mart:'],
                ...
                [
                    ...
                    'body' => ['The manufacturer\'s warranty policies generally govern any repairs, replacements, or warranty-related services.', 'Zero Tech Mart does not guarantee:'],
                ...
                [
                    ...
                    'body' => ['Warranty references appearing on the website are provided solely as general information.', 'Zero Tech Mart does not warrant that:'],
                ...
                [
                    ...
                    'body' => ['Zero Tech Mart shall not be responsible for:'],
                ...
                [
                    ...
                    'body' => [
                        ...
                        'Zero Tech Mart does not assume responsibility for third-party warranty programs.',
                    ],
                ],
                [
                    ...
                    'body' => [
                        ...
                        'Zero Tech Mart is not responsible for monitoring or immediately updating all manufacturer warranty changes.',
