...
class QuoteRequestPolicyController extends Controller
{
    public function index()
    {
        $quotePolicy = [
            ...
            'date' => 'July 2026',
            'intro' => [
                'This Quote Request Policy explains how quote requests and product inquiries submitted through XTech Mart are handled.',
                'XTech Mart operates as a technology, information, and product discovery platform. The website provides information regarding printers, scanners, desktops, thin clients, and related technology products. Users may submit quote requests to obtain additional information regarding products, availability, specifications, or other product-related details.',
            ...
            'sections' => [
                [
                    ...
                    'body' => ['The quote request feature is intended to facilitate communication between website users and XTech Mart.', 'Quote requests may be used to:'],
                ...
                [
                    ...
                    'notes' => [
                        'A quote request is simply a request for information and does not create any contractual relationship between the user and XTech Mart.',
                ...
                [
                    ...
                    'notes' => [
                        ...
                        'XTech Mart may be unable to respond effectively to requests containing incomplete or inaccurate information.',
                    ],
                ],
                [
                    'title' => 'Review Of Quote Requests',
                    'body' => ['All quote requests are subject to review.', 'XTech Mart reserves the right to:'],
                ...
                [
                    ...
                    'notes' => [
                        'XTech Mart does not guarantee that products referenced on the website will be available at any specific time.',
                ...
                [
                    ...
                    'notes' => [
                        ...
                        'XTech Mart reserves the right to modify or withdraw pricing information at any time.',
                    ],
                ],
                [
                    'title' => 'Product Information Accuracy',
                    'body' => ['While reasonable efforts are made to provide accurate information, XTech Mart does not guarantee that:'],
                ...
                [
                    ...
                    'note' => 'XTech Mart reserves the right to reject requests that appear misleading, abusive, fraudulent, or inconsistent with the website\'s intended purpose.',
                ],
                [
                    'title' => 'Communication Regarding Requests',
                    'body' => ['After a quote request is submitted, XTech Mart may contact users using the information provided.', 'Communication may include:'],
                    ...
                    'note' => 'Submission of a quote request authorizes XTech Mart to communicate regarding the submitted inquiry.',
                ],
                [
                    'title' => 'No Guarantee Of Response Time',
                    'body' => ['While reasonable efforts may be made to review inquiries promptly, XTech Mart does not guarantee:'],
                ...
                [
                    ...
                    'body' => ['XTech Mart reserves the right to refuse, restrict, or discontinue communication regarding any request at its sole discretion.', 'Requests may be refused for reasons including:'],
                    ...
                    'note' => 'XTech Mart is not obligated to explain decisions regarding request refusal.',
                ],
                [
                ...
                [
                    ...
                    'body' => ['XTech Mart shall not be liable for:'],
                ...
                [
                    ...
                    'body' => [
                        'XTech Mart reserves the right to modify, update, or replace this Quote Request Policy at any time without prior notice.',
