...
class DmcaCopyrightPolicyController extends Controller
{
    public function index()
    {
        $dmcaPolicy = [
            ...
            'date' => 'July 2026',
            'intro' => [
                'XTech Mart respects the intellectual property rights of others and expects website users to do the same.',
                'This Digital Millennium Copyright Act ("DMCA") Policy outlines the procedures for reporting alleged copyright infringement and submitting copyright-related notices concerning content appearing on the XTech Mart website.',
                'XTech Mart operates as a technology information and product discovery platform and is committed to responding appropriately to valid copyright concerns in accordance with applicable intellectual property laws.',
            ...
            'sections' => [
                [
                    ...
                    'note' => 'XTech Mart respects these rights and takes copyright concerns seriously.',
                ],
                [
                ...
                [
                    ...
                    'body' => [
                        ...
                        'Upon receipt of a valid notice, XTech Mart may:',
                    ],
                ...
                [
                    ...
                    'note' => 'XTech Mart may review counter-notifications and take appropriate action under applicable law.',
                ],
                [
                    'title' => 'Repeat Infringer Policy',
                    'body' => ['XTech Mart reserves the right to take appropriate action against users who repeatedly infringe intellectual property rights.', 'Actions may include:'],
                    'items' => ['Restricting Website Access', 'Removing Content', 'Suspending User Privileges', 'Terminating Access To Website Services'],
                    'note' => 'The determination of repeat infringement shall be made at XTech Mart\'s sole discretion.',
                ],
                [
                    ...
                    'note' => 'XTech Mart reserves the right to reject notices that appear abusive, incomplete, or submitted in bad faith.',
                ],
                [
                    'title' => 'Third-Party Content',
                    'body' => [
                        'The website may contain information, content, or materials obtained from third-party sources.',
                        'XTech Mart does not claim ownership of third-party copyrighted materials unless expressly stated.',
                ...
                [
                    ...
                    'body' => ['XTech Mart reserves the right to:'],
                ...
                [
                    ...
                    'body' => [
                        'XTech Mart reserves the right to update, modify, or replace this DMCA Copyright Policy at any time.',
