...
@section('content')
    ...
    <main class="trademark-document policy-document">
        @include('themes.sarab.policy.partials.navigation')
        <div class="trademark-document__inner policy-document__content">
            <h1>{{ $disclaimer['title'] }}</h1>
