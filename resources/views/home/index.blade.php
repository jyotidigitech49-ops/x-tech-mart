            ...
            <div class="row g-3 justify-content-center">
               <div class="col-6 col-sm-4 col-md-3 col-lg-2" data-aos="zoom-in" data-aos-delay="0">
                  <div class="catcard active" data-filter="all">
                     <img class="catimg" src="{{ asset('themes/sarab/img/category/1.jpg') }}" alt=""/>
               ...
               <div class="col-6 col-sm-4 col-md-3 col-lg-2" data-aos="zoom-in" data-aos-delay="70">
                  <div class="catcard" data-filter="burgers">
                     <img class="catimg" src="{{ asset('themes/sarab/img/category/2.jpg') }}" alt=""/>
               ...
               <div class="col-6 col-sm-4 col-md-3 col-lg-2" data-aos="zoom-in" data-aos-delay="140">
                  <div class="catcard" data-filter="pizza">
                     <img class="catimg" src="{{ asset('themes/sarab/img/category/3.jpg') }}" alt=""/>
               ...
               <div class="col-6 col-sm-4 col-md-3 col-lg-2" data-aos="zoom-in" data-aos-delay="210">
                  <div class="catcard" data-filter="chicken">
                     <img class="catimg" src="{{ asset('themes/sarab/img/category/4.jpg') }}" alt=""/>
               ...
               <div class="col-6 col-sm-4 col-md-3 col-lg-2" data-aos="zoom-in" data-aos-delay="280">
                  <div class="catcard" data-filter="wraps">
                     <img class="catimg" src="{{ asset('themes/sarab/img/category/5.jpg') }}" alt=""/>
               ...
               <div class="col-6 col-sm-4 col-md-3 col-lg-2" data-aos="zoom-in" data-aos-delay="350">
                  <div class="catcard" data-filter="desserts">
                     <img class="catimg" src="{{ asset('themes/sarab/img/category/6.jpg') }}" alt=""/>
            ...
            <div class="row align-items-center g-5">
               <div class="col-lg-5" data-aos="fade-right">
                  <div class="astack">
                     ...
                     <div class="amain"><img src="{{ asset('themes/sarab/img/about1.jpg') }}" alt="Restaurant"/></div>
               ...
               <div class="swiper-wrapper">
                  <div class="swiper-slide">
                     <div class="tescard">
                        ...
                        <div class="tesauth">
                           <img src="{{ asset('themes/sarab/img/testimonial/1.jpg') }}" alt=""/>
                           <div>
                  ...
                  <div class="swiper-slide">
                     <div class="tescard">
                        ...
                        <div class="tesauth">
                           <img src="{{ asset('themes/sarab/img/testimonial/2.jpg') }}" alt=""/>
                           <div>
                  ...
                  <div class="swiper-slide">
                     <div class="tescard">
                        ...
                        <div class="tesauth">
                           <img src="{{ asset('themes/sarab/img/testimonial/3.jpg') }}" alt=""/>
                           <div>
                  ...
                  <div class="swiper-slide">
                     <div class="tescard">
                        ...
                        <div class="tesauth">
                           <img src="{{ asset('themes/sarab/img/testimonial/4.jpg') }}" alt=""/>
                           <div>
