...
var cH = 8,
    cM = 45,
    cS = 30;
var cdHour = document.getElementById('cdH');
var cdMinute = document.getElementById('cdM');
var cdSecond = document.getElementById('cdS');
if (cdHour && cdMinute && cdSecond) setInterval(function() {
    cS--;
    if (cS < 0) {
        cS = 59;
        cM--;
    ...
    cdHour.textContent = String(cH).padStart(2, '0');
    cdMinute.textContent = String(cM).padStart(2, '0');
    cdSecond.textContent = String(cS).padStart(2, '0');
}, 1000);
